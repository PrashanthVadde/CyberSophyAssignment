...
df = pd.DataFrame(starting_and_ending_timings_list, columns=["Starting Logging time", "Ending Logging time", "Source", "Task category"])

df.to_csv("D:\\CyberSophy-assignment.csv")

df = pd.read_csv("D:\\CyberSophy-assignment.csv")
